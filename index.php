...
<style type="text/css">
	@import 'https://fonts.googleapis.com/css?family=Baloo+Da+2&display=swap';
	* {
	outline: none;
}
...
<div class="jumbotron">
  <h1 class="display-4">AudDrive</h1>
  <p class="lead">Upload mp3 songs from your desktop and listen to music without Ads!!</p>
  <hr class="my-4">
  <p>This app has been deployed on Heroku using Firebase, javascript and php!</p>
